...
# Config , hard coded SUE ME. batch_size is bascially maxed out. System prefix should not change across code #TODO Probabbly should set gloabl config, file structure is outlined tho
